...
export const postNotesTx = (code: AccountCode, { internalTxID, note }: INoteTx): Promise<null> => {
...
export const proposeTx = (accountCode: AccountCode, txInput: TTxInput): Promise<TTxProposalResult> => {
